...
- [x] Улучшить систему анализа
  - [x] Добавить поле page_url для точного отслеживания
  - [x] Нормализовать значения city для корректного сравнения
  - [x] Оптимизировать SQL запросы для анализа
- [ ] Добавить расширенный анализ
  - [ ] Добавить еженедельное сравнение
  - [ ] Учитывать сезонность запросов
  - [ ] Анализ конкурентов по категориям
  - [ ] Добавить анализ по группам URL (блог/основной сайт)
  - [ ] Реализовать отчеты по категориям запросов
...
## В работе
- [ ] Добавить фильтрацию по типам страниц (категории, товары, статьи)
- [ ] Реализовать сравнение позиций с предыдущим периодом

## Выполнено
- [x] Интеграция с Google Search Console API
- [x] Создание базовой структуры бота
- [x] Настройка логирования
- [x] Добавление поддержки городов
- [x] Интеграция с Google Analytics API
- [x] Выгрузка данных в Google Sheets
- [x] Добавление URL страниц в выгрузку
- [x] Создание отдельных листов по городам
...
### 7. Настройка Google Tag Manager
- [x] Базовая настройка GTM
  - ✅ Создание и настройка контейнера
  - ✅ Интеграция с GA4
  - ✅ Настройка Enhanced Measurement
...
### 8. Система отслеживания заказов
#### 8.1 Расширение GTM

        ...
        with db.get_connection() as conn:
            with conn.cursor() as cur:
                ...
                try:
                    ...
                    logger.warning(f"Constraint already exists for search_queries: {str(e)}")
                ...
                try:
                    ...
                    logger.warning(f"Constraint already exists for daily_metrics: {str(e)}")
                ...
                try:
                    ...
                    logger.warning(f"Constraint already exists for position_changes: {str(e)}")
